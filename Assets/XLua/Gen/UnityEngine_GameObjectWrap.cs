...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 17, 10, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "IsDestroying", _m_IsDestroying);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsDestroying(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsDestroying(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
