...
This project is pinned to **Unity 6000.5.1f1** with URP 17.5 (2D Renderer), targeting Android.
Before suggesting any Unity API, class, or package:

1. Check `docs/engine-reference/unity/VERSION.md` and the relevant `modules/*.md`.
2. If an API postdates the knowledge cutoff listed there, flag it explicitly rather than
   asserting it works.
3. Prefer what the engine-reference files document over training data when they conflict.
